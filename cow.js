...
const mat_cream = new THREE.MeshStandardMaterial({color: 0xfffdd0})

const mat_brown = new THREE.MeshStandardMaterial({
  color: 0x4c3228,
...
const mat_very_dark_grey = new THREE.MeshStandardMaterial({
  color: 0x010101,
  side: THREE.DoubleSide
});
